...
<div class="container">
    <h1>{{ isset($dataKaryawan) ? 'Edit Data Karyawan' : 'Tambah Data Karyawan' }}</h1>
    <form action="{{ isset($dataKaryawan) ? route('data_karyawans.update', $dataKaryawan->id) : route('data_karyawans.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary">
                {{ isset($dataKaryawan) ? 'Update' : 'Simpan' }}
            </button>
        </div>
    </form>
</div>
